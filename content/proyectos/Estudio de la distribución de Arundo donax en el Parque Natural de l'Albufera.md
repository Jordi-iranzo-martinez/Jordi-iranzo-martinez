El [Estudio sobre la caña común (Arundo donax) en el Parque Natural de l’Albufera](static/albufera-arundo-donax.pdf) (2019) fue un análisis para el Ayuntamiento de València. 
...
- Sugerencias de mejora y zonificación según vulnerabilidad

La metodología se realizó mediante el análisis visual de imágenes por satélite del [Instituto Cartográfico Valenciano](https://icv.gva.es/) (ICV), el [Centro Nacional de Información Geográfica](https://centrodedescargas.cnig.es/CentroDescargas/home) (CNIG) del [Instituto Geográfico Nacional](https://www.ign.es/web/inicio?locale=es)(IGN), y Google Earth, así como tratamiento de datos con el sistema de información geográfica Q-GIS.
