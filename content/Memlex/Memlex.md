...
_Memlex is the trade name for a flashcard marketplace focused on legal regulations and language vocabulary, available in both Spanish and English. The name comes from the combination of "memorization" with lex (Latin for "law") and lexicon (English for "vocabulary").
_
...
_The flashcards are designed for use with RemNote, a free program (similar to Anki). Its name derives from the word "note" and the acronym for “Retrievable Element of Memory.” RemNote allows you to write notes and turn each piece of information into a unit suitable for active recall and spaced repetition. It includes advanced features such as hierarchical organization and is available for both desktop and mobile.
_
...
_The legal regulation flashcards contain the exact wording of the law, presented in an enriched format (bold, italics, underline, hyperlinks...) that enhances readability. There is one flashcard per article, as well as additional cards for key terms and figures.
_
...
_They are tailored for use in Spanish public administration and environmental law. The content includes laws passed by the Spanish Parliament, Royal Decrees issued by the Spanish Government, and European Union regulations, as well as international treaties (the latter in English).
_
...
_The vocabulary flashcards are bidirectional and primarily written in English. Some are based on third-party materials —always with permission— while others are original. English vocabulary cards include both the word and its definition, while cards for other languages only provide the translation.
_
...
_The legal flashcards are organized into thematic packs. You can request specific regulations by writing directly to jordi.im@proton.me.
_
Puedes suscribirte si quieres recibir noticias cuando existan algunas nuevas y recibir descuentos exclusivos. 

_You may also subscribe if you wish to receive updates when new cards are released and gain access to exclusive discounts.
_
...
_Please note that as this is a digital product, returns are not applicable and therefore refunds are not available.
_
