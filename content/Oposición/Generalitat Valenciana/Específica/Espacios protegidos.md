...
- **Proyecto de declaración**: por la Conselleria de Medio Ambiente, en el que conste la delimitación del mismo (y el área de protección perimetral, en su caso), la clase de espacio natural propuesto, el régimen de protección preventiva aplicable, y otras disposiciones que se consideren necesarias.

- **Participación pública**: el proyecto de declaración será sometido a información pública durante un mes, y se dará audiencia a las corporaciones locales, entidades y asociaciones que ejerzan la representación de los intereses afectados por la declaración. *Igualmente, podrán utilizarse otras formas y medios de participación de los ciudadanos y ciudadanas afectados por la declaración.*

- **Propuesta de declaración**: elaborada por la Conselleria de medio ambiente, tras el periodo de información pública (observaciones, alegaciones, informes...), para su elevación al Consell.
...
Elaborado el plan rector de uso y gestión, se someterá a información pública y audiencia de corporaciones, entidades e interesados personados en el expediente (artículo 26.2).
