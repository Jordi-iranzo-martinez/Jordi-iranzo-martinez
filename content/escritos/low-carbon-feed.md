---
title: "Low Carbon Feed - El valor de los residuos agricolas.md"
---

*Publicado originalmente en [Revista Espores](https://espores.org/es/es-agricultura/low-carbon-feed-el-valor-de-los-residuos-agricolas/)*
...
![*Recogida de restos de poda de cítricos. / LIFE Low Carbon Feed (LCFEED).*](attachments/Escritos/attachments/lcfeed/lcfeed-recogida-poda-citricos.png)
...
Los principales cultivos españoles son cereales como la cebada (_Hordeum vulgare_) y el trigo (_Triticum spp_.); y cultivos leñosos (árboles) de secano como el olivo (_Olea europaea_), el almendro (_Prunus dulcis_) y la vid (_Vitis vinifera_).
