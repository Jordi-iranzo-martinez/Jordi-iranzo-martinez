...
La norma básica estatal es la [Ley 37/2003](https://www.boe.es/buscar/act.php?id=BOE-A-2003-20976)
...
- **Zonas de servidumbre acústica**: delimitación y limitaciones
- **Áreas acústicas**: delimitación en un mapa de ruido
- **Objetivos de calidad**: suspensión provisional
- **Planes de acción**: elaboración, aprobación y revisión para cada mapa de ruido, información pública, y ejecución de las medidas incluidas.
- **Corrección**: declaración de las Zonas de Protección Acústica Especial (ZEPA) y de Situación Acústica Especial (ZESA), y realización respectivamente del plan zonal (elaboración, aprobación, ejecución) y las medidas correctoras (adopción, ejecución).
...
- **Zonificación**: clasificación del territorio por las Comunidades Autónomas en áreas acústicas, según el uso predominante del suelo, con la siguiente tipología mínima (a desarrollar por normativa autonómica): industrial, recreativo y de espectáculos, terciario distinto, sanitario, docente y cultural, afectados por sistemas generales de infraestructuras de transporte, y espacios naturales. Cada tipo tendrá unos objetivos de calidad concretos.

- **Planes de acción en materia de contaminación acústica**: para afrontar las cuestiones del ruido y sus efectos, afrontando las cuestiones de las áreas acústicas, determinando las medidas (incluyendo aquellas prioritarias en caso de superación de valores límite e incumplimiento de objetivos), y protección de las zonas tranquilas. Con revisión cada máximo 5 años (y antes si cambian las condiciones)

- **Mapas de ruido**: para los grandes ejes viarios, ferroviarios, aeropuertos, aglomeraciones, y zonas donde se hayan incumplido los objetivos de calidad acústica.

- **Zonas de Protección Acústica Especial**: si se incumplen los objetivos de calidad acústica, 

- **Zonas de Situación Acústica Especial**: si las medidas no pudieran evitar el incumplimiento de objetivos de calidad, con medidas correctoras a largo plazo, y al menos el cumplimiento en el espacio interior.
...
| Títulos                                          | Contenido                                                                                                                                                                                                                                                                                                                              |
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Disposiciones generales**                      | **- Objeto**<br>**- Concepto**<br>**- Ámbito de aplicación**<br>**- Competencias administrativas**<br>**- Ordenanzas municipales**<br>**- Principios de actuación**                                                                                                                                                                    |
| **Valoración de ruidos y vibraciones y niveles** | **- Valoración**<br>**- Niveles de perturbación**                                                                                                                                                                                                                                                                                      |
| **Planes y programas acústicos**                 | **- Disposiciones generales**<br>**- Plan Acústico de Acción Autonómica**<br>**- Planes Acústicos Municipales: normas generales, mapas acústicos**<br>**- Zonas acústicamente saturadas**                                                                                                                                              |
| *Ámbitos de regulación específica*               | *- Edificación<br>- Actividades comerciales, industriales, y de servicios: normas generales, espectáculos, establecimientos públicos y actividades recreativas<br>- Trabajos en vía pública en la edificación<br>- Sistemas de alarma y comportamiento de los ciudadanos: vehículos a motor, ruidos de infraestructuras de transporte* |
...
Se entiende por contaminación acústica o ruido ambiental: 

>"Los sonidos y las vibraciones no deseados o nocivos generados por la actividad humana".

Esto incluye lo siguiente:

- **Actividades, comportamientos, instalaciones, medios de transporte y máquinas** (por su funcionamiento, uso o ejercicio)

- **Elementos constructivos y ornamentales** (en tanto contribuyan a la transmisión de ruidos y vibraciones producidos en su entorno).

La *Generalitat* y las administraciones locales ejercerán de forma coordinada sus competencias. La *Generalitat* y las diputaciones provinciales prestarán colaboración técnica y financiera a los municipios.

*En defecto de atribución expresa, la competencia será de la Conselleria competente en medio ambiente.*

Los ayuntamientos podrán desarrollar las prescripciones mediante ordenanzas municipales. El Plan Acústico de Acción Autonómica establecerá modelos de regulación orientativos para éstas.

La acción de la *Generalitat* y de las administraciones locales se basará en el ejercicio coordinado de sus competencias, conforme a los principios (por este orden):
...
- **Información**: sobre las consecuencias del ruido sobre la salud de las personas y los usos y prácticas cotidianos que permitan disminuir los niveles acústicos.
...
Los niveles de ruido se medirán y expresarán en decibelios con ponderación normalizada A (expresada como dB(A)). 

Reglamentariamente se determinarán:

- Procedimientos de medición y evaluación de niveles sonoros
- Aislamientos acústicos
- Protección aportada a los ocupantes de inmuebles
- Niveles sonoros producidos por vehículos a motor y otros medios de transporte
- Otros análogos

Las vibraciones se expresarán como aceleración de metros por segundo cada segundo (m/s²). En edificios, se medirá la aceleración eficaz de vibración mediante análisis en bandas de tercio de octava. Reglamentariamente se establecerá el procedimiento para el cálculo del índice K de molestia.

Se establecen los parámetros de ruidos y vibraciones (Anexo I) 

*Los términos no indicados se interpretarán de acuerdo al Código Técnico de la Edificación: Ley de Ordenación de la Edificación, y en su defecto, las Normas Básicas de la Edificación: Condiciones Acústicas de la Edificación (NBE-CA-88), sus posibles modificaciones, las normas UNE-EN y, en su defecto, las normas ISO.*
...
Las mediciones se realizarán por los siguientes instrumentos (según procedimientos establecidos reglamentariamente):

| Tipo de contaminación acústica | Instrumentos de medida                                                            |
| ------------------------------ | --------------------------------------------------------------------------------- |
...
- **Ambiente exterior**: de acuerdo a la tabla 1 del Anexo II según el uso dominante de la zona (reglamentariamente se establecerá el procedimiento de evaluación), expresados como nivel sonoro continuo equivalente (LAeq,T), de acuerdo al uso predominante de cada zona.

	*Si la zona no corresponde a ninguna de las establecidas en la tabla, se aplicará la más próxima por razones de analogía funcional o necesidad de protección acústica. En las zonas de uso dominante terciario en las que esté permitido el uso residencial, se aplicarán los niveles correspondientes a este último.*

- **Ambiente interior**: ninguna actividad o instalación transmitirá al interior de los locales próximos o colindantes niveles sonoros superiores a los límites establecidos en la tabla 2 del anexo II (se aplicarán asimismo a los locales o usos no mencionados, atendiendo a razones de analogía funcional o de equivalente protección acústica).

- **Niveles de emisión sonora**: vienen limitados por los niveles de recepción establecidos en los artículos anteriores (además de por los supuestos de regulación específica: título IV).

- **Niveles de vibraciones**: las máquinas o dispositivos que puedan originar vibraciones en el interior de los edificios se efectuará adoptando los elementos antivibratorios adecuados, cuya efectividad deberá justificarse en los correspondientes proyectos. No se permitirán aquellos que sobrepasen los valores de K regulados para interior de los edificios (tabla 1 del Anexo III) 
...
La planificación tiene por objeto la identificación de los problemas y el establecimiento de las medidas preventivas y correctoras necesarias para mantener los niveles sonoros por debajo de los previstos. 

Los instrumentos de planificación y gestión acústica vincularán a todas las administraciones públicas y a ciudadanos de la Comunidad Valenciana.

| Instrumeto                                   | Función                                                                                                                                                                                                                                                                                                                                                                                       |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Plan Acústico de Acción Autonómica           | - Coordinación de las actuaciones de la Administración<br>- Fomentar la adopción de medidas para su prevención y la reducción de las emisiones sonoras por encima de los máximos legalmente previstos<br>- Concienciar y formar a los ciudadanos<br>- Potenciar la investigación e implantación de nuevas tecnologías para conseguir la reducción o eliminación de la contaminación acústica. |
| Planes acústicos municipales                 | - Identificación de sus áreas acústicas de acuerdo con su uso (existente o previsto) y condiciones acústicas<br>- Adopción de medidas de mitigación de emisiones.                                                                                                                                                                                                                             |
| Ordenanzas municipales                       | - Análisis de los niveles de ruido en el término municipal <br>- Información sobre las fuentes de contaminación                                                                                                                                                                                                                                                                               |
| Declaración de Zonas Acústicamente Saturadas | Sobrepasen los niveles: <br>- Frecuencia: 2 veces por semana durante 3 semanas consecutivas o 3 alternas (en 35 días naturales)<br>- Intensidad: más de de 20 dB(A) en el ambiente exterior (tabla 1 del anexo II)<br>- Método: LA,eq,1 (periodo nocturno) y LA,eq,14 (diurno)                                                                                                                |

El Plan Acústico de Acción Autonómica es el instrumento aprobado por Acuerdo del Consell (elaborado por la Conselleria de medio ambiente)


¿ESTO?

- **Medidas de prevención y reducción**: investigación e incorporación de mejoras tecnológicas
	- Construcciones e instalaciones
	- Desarrollo de actividades
	- Procesos de producción
	- Productos finales constitutivos de fuentes sonoras
...
- **Medidas correctoras** a fin de garantizar los niveles de inmisión (título II).
...
Los Planes acústicos municipales permiten la identificación de las áreas acústicas del municipio en según su uso existente o previsto y sus condiciones acústicas, así como la adopción de medidas que permitan la progresiva reducción de sus niveles sonoros para situarlos por debajo de los previstos.

- Ordenación de las actividades generadoras de ruido implantadas o a implantar en el ámbito de aplicación del Plan.
...
- **Otras**: para reducir los niveles de ruido

El procedimiento incluye las etapas siguientes: 

1. **Proyecto**: por los Ayuntamientos, de acuerdo a un proyecto suscrito por una persona especialista
2. **Información pública**: por un mes, por anuncios en el Diari Oficial de la Generalitat Valenciana y en uno de los diarios de información general de mayor difusión en la provincia. 
3. **Trámite de audiencia** a las asociaciones vecinales interesadas.
4. **Informe vinculante**: por la Conselleria de medio ambiente emitirá informe vinculante en el plazo de un mes (si no lo emite se interrumpirá en procedimiento)
5. **Aprobación**: por el pleno del Ayuntamiento, en un plazo de 2 meses (desde la remisión del informe a Conselleria)
6. **Publicación**: del acuerdo, en el Boletín Oficial de la Provincia y el Diari Oficial de la Generalitat Valenciana
7. **Entrada en vigor**: al día siguiente de su publicación (salvo que en ellos se disponga lo contrario)
...
Los mapas acústicos tienen por objeto analizar los niveles de ruido existentes en el término municipal y proporcionar información sobre las fuentes sonoras causantes de la contaminación acústica.

Distinguirán entre zonas rústicas y urbanas, estableciendo 

- **Áreas diferenciadas por uso** (existente o previsto)
...
- **Fuentes** que generan la contaminación acústica
- **Condiciones de calidad sonora** que requieran los valores existentes en ellas:
...
| Títulos                                | Contenido                                                                                                                                                                                                                                                                                                                                   |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Disposiciones generales                | - Objeto<br>- Ámbito de aplicación<br>- Competencias administrativas<br>- Ordenanzas municipales                                                                                                                                                                                                                                            |
| Niveles de evaluación y valores límite | - Evaluación<br>- Valores límite                                                                                                                                                                                                                                                                                                            |
...
El procedimiento de medición del aislamiento acústico (DnT,w) y las condiciones en que se podrá utilizar como parámetro de evaluación la diferencia de niveles (Dw) quedan establecidos (Anexo IV).

El estudio acústico (artículo 36 de la Ley 7/2002) deberá ser firmado por técnico competente y se presentará en capítulo aparte, en el estudio de impacto ambiental, al solicitar:
...
- **Nivel de ruido en el estado preoperacional**: mediante la elaboración de un informe de los niveles sonoros (LAeq,t) en el ambiente exterior del entorno de la actividad, infraestructura o instalación (tanto en el periodo diurno como en el nocturno)
...
- **Definición de las medidas correctoras de la transmisión de ruidos o vibraciones a implantar en la nueva actividad**: en caso de resultar necesarias como consecuencia de la evaluación efectuada, y previsión de los efectos esperados. Deberá tenerse en cuenta las prescripciones para prevenir la transmisión de vibraciones (artículo 16).

En los proyectos de actividades se considerarán las posibles molestias por ruido que, por efectos indirectos, puedan ocasionarse en las inmediaciones de su implantación, con objeto de proponer y diseñar las medidas correctoras adecuadas para evitarlas o disminuirlas.

*Deberá prestarse especial atención a las actividades que generan tráfico elevado de vehículos (almacenes, locales públicos y, especialmente, actividades previstas en zonas de elevada densidad de población o con calles estrechas de difícil maniobra y/o con escasos espacios de aparcamiento y aquellas que requieren operaciones de carga o descarga).*

Será responsabilidad de los titulares de actividades susceptibles de generar ruidos y vibraciones llevar a cabo un control de las emisiones acústicas y de los niveles de recepción en el entorno (artículo 37 de la Ley 7/2022), mediante la realización de auditorías acústicas, al inicio del ejercicio de la actividad o puesta en marcha y, al menos, cada 5 años (en un plazo inferior si así se estableciera en el procedimiento en que se evaluara el estudio acústico).

La auditoría acústica deberá ser realizada por una entidad colaboradora en materia de calidad ambiental para el campo de la contaminación acústica (Decreto 229/2004). 

Finalizada la auditoría acústica, la entidad colaboradora remitirá informe de resultados al titular de la actividad y un certificado del estado general de la actividad respecto de las prescripciones obligatorias (Ley 7/2002, presente decreto o en la autorización sustantiva).
...
- En su caso, el resultado y la efectividad de las medidas correctoras de la contaminación acústica adoptadas en la actividad o instalación.
 ...
 Si en la auditoría acústica la entidad colaboradora detectase el incumplimiento de las prescripciones obligatorias (Ley 7/2002, presente decreto o autorización sustantiva), esta estará obligada a ponerlo de inmediato en conocimiento del ayuntamiento, remitiéndole copia del correspondiente certificado desfavorable.
...
En aquellos locales en los que el nivel sonoro sea superior a 90 dB(A) deberá colocarse, en sus accesos, un aviso que diga lo siguiente: 

> "El nivel de ruido existente en este local puede ser perjudicial para su salud".

*Deberá estar escrito en las dos lenguas oficiales y ser visible y legible a 5 metros.*
...
La administración municipal fijará mediante ordenanzas o planes acústicos municipales las distancias mínimas que se deberán respetar en cuanto a la implantación de determiadas actividades (artículo 41 de la Ley 7/2022), para evitar efectos acumulativos:

- Zonas de uso dominante residencial
- Zonas de uso sanitario y docente
- Discotecas
- Salas de fiesta
- Pubs
- Bares, restaurantes y similares que cuenten con ambientación musical
- Otras productoras de ruidos y vibraciones
